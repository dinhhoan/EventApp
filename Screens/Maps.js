...
const parkingsSpots = [
  {
    ...
    description: `infomation event 1`,
  },
  {
    id: 2,
    title: 'Event 2',
    ...
    description: `infomation event 2`,
  },
  {
    id: 3,
    title: 'Event 3',
    ...
    description: `infomation event 3`,
  },
];
    ...
    return (
      <View style={styles.header}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          ...
          <Text style={styles.headerLocation}>Da Nang, VN</Text>
        </View>
      ...
      >
        <View style={styles.modal}>
          ...
          <View style={styles.modalHours}>
            <Text style={{ textAlign: 'center', fontWeight: '500' }}>Choose your Events Period:</Text>
